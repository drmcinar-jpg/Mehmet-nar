...
VARSAYILAN = {
    ...
    "calistirma_basina_azami_ozet": 150,
    "_ozet_limit_not": ("Beklenmedik maliyeti onlemek icin tek calistirmada uretilecek azami "
                    "ozet sayisi. Ozetler onbellege alinir, ayni makale iki kez ozetlenmez. "
